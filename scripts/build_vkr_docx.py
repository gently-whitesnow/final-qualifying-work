...
def add_toc(doc: Document, *, kind: str = "vkr"):
    ...
    if kind == "practice":
        entries = [
            ...
            (2, "1.1 Описание использованной литературы", 6),
            (2, "1.2 Real-time взаимодействие в системах отслеживания задач", 8),
            (2, "1.3 WebSocket и SignalR как основа real-time контура", 9),
            (2, "1.4 Ограничение single-node WebSocket-архитектуры", 10),
            (2, "1.5 Сравнение подходов к масштабированию", 11),
            (2, "1.6 Вывод по главе", 11),
            (1, "2. Анализ целевой системы и постановка задачи практики", 13),
            ...
            (2, "2.4 Выбор платформы и инструментальных средств", 15),
            (2, "2.5 Постановка задачи", 15),
            (1, "3. Проектирование масштабируемого real-time контура", 17),
            (2, "3.1 Исходная архитектура", 17),
            ...
            (1, "4. Выполнение индивидуального задания", 21),
            (2, "4.1 Организация работ", 21),
            (2, "4.2 Изменения backend", 21),
            (2, "4.3 Проверочный клиент", 22),
            (2, "4.4 Инфраструктурные изменения", 22),
            (2, "4.5 Автоматизированный сценарий проверки", 23),
            (1, "5. Результаты практики и оценка решения", 25),
            (2, "5.1 Цель и программа испытаний", 25),
            (2, "5.2 Стенд испытаний", 25),
            (2, "5.3 Результат без Redis backplane", 26),
            (2, "5.4 Результат с Redis backplane", 26),
            (2, "5.5 Серийная проверка и задержка доставки", 27),
            (2, "5.6 Проверка восстановления соединения и отказа узла", 28),
            (2, "5.7 Сравнительная таблица результатов", 28),
            (2, "5.8 Проверка входной точки стенда", 29),
            (2, "5.9 Оценка достоверности результатов", 29),
            (2, "5.10 Вывод по испытаниям", 30),
            (1, "ЗАКЛЮЧЕНИЕ", 30),
            (1, "СПИСОК ИСПОЛЬЗОВАННЫХ ИСТОЧНИКОВ", 32),
            (1, "ПРИЛОЖЕНИЕ А", 34),
        ]
    else:
        entries = [
