...
### 5.6 Проверка входной точки стенда
...
3. Сценарием остановки одного экземпляра `app-api` и проверки восстановления соединения.
